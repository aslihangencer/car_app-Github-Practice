...
export default function CarCard({ car, onSelect, isSelected }: Props) {
    ...
    return (<div className={`group relative bg-slate-900 border-2 rounded-3xl overflow-hidden transition-all duration-500 ${isSelected ? 'border-emerald-500 scale-[1.02] shadow-2xl shadow-emerald-500/20' : 'border-slate-800/50 hover:border-slate-700'}`}>
